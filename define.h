...
#define CLR_NO_TRACK            18      /// Цвет неопознанной трассы
#define CLR_FR_TRACK            13      /// Цвет своей трассы                   (Тёмно-Красный)
#define CLR_AL_TRACK            15      /// Цвет чужой трассы                   (Тёмно-Синий)
#define CLR_TRUE_NO_TRACK       12      /// Цвет подтверждённой неопознанной трассы
...
/// Пути к картинкам
#define OUR                     "_Svoi"   /// Свой Цвет Красный
#define ANOTHERS                "_Chuj"   /// Чужой Цвет Синий
#define MANY                    "_One"    /// Сопровождается одним источником Цвет Светлый(Светло-синий или светло-красный)
#define ONE                     "_Many"   /// Сопровождается более чем одним источником Цвет Темный(Темно-синий или темно-красный)
...
#define XY_INTERVAL             1000    /// Интервал обновления отрисовки (в мс)
